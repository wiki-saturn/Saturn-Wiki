...
#### В данном руководстве описывается процесс загрузки, установки и настройки приложения Happ на Android устройстве для удобного использования VPN через протокол VLESS.
...
1. Откройте страницу в [Google Play](https://play.google.com/store/apps/details?id=com.happproxy) и установите Happ.

::: info **Подсказка** 
Если у вас недоступен Google Play, вы можете загрузить файл .apk со стороннего сайта и установить приложение вручную.
:::

![Установка](/public/pages/android/happ/1.webp)
...
![Импорт конфигурации](/public/pages/android/happ/2.webp)
...
![Подключение к VPN](/public/pages/android/happ/3.webp)
...
![Обновление подписки](/public/pages/android/happ/4.webp)
