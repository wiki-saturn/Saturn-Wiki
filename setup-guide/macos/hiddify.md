...
head:
  - - meta
    - property: og:image
      content: /pages/macos/hiddify/opengraph.webp
  - - meta
    - name: twitter:image
      content: /pages/macos/hiddify/opengraph.webp
---
...
![Установка](/pages/macos/hiddify/1.webp)
...
![Импорт конфигурации](/pages/macos/hiddify/2.webp)
...
![Настройки приложения](/pages/macos/hiddify/3.webp)
...
![Подключение к VPN](/pages/macos/hiddify/4.webp)
...
![Обновление подписки](/pages/macos/hiddify/5.webp)
...
![Настройка исключений доменов](/pages/macos/hiddify/6.webp)
