---
title: Подключение к VPN через Hiddify на macOS (VLESS)
description: В данном руководстве описывается процесс загрузки, установки и настройки приложения Hiddify на компьютере Mac для удобного использования VPN через протокол VLESS.
---
...
![Установка](/public/pages/macos/hiddify/1.webp)
...
![Импорт конфигурации](/public/pages/macos/hiddify/2.webp)
...
![Настройки приложения](/public/pages/macos/hiddify/3.webp)
...
![Подключение к VPN](/public/pages/macos/hiddify/4.webp)
...
![Обновление подписки](/public/pages/macos/hiddify/5.webp)

## Раздельное туннелирование в Hiddify
...
![Настройка исключений доменов](/public/pages/macos/hiddify/6.webp)
